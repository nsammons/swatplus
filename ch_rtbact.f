...
!     skipping hourly bacteria route for now  04/16/07 nubs
      if (bsn_cc%event > 2) then                !! hourly mass balance
        initlp = 0.
        initp = 0.
        ...
        do ii = 1, nstep
          ...
          totbactp = 0.
          totbactlp = 0.
          totbactp = ts(ii)%hh(inum2)%bacp * ts(ii)%hh(inum2)%flo *     
     &                                (1. - rnum1) + initp * hrchwtr(ii)
          totbactlp = ts(ii)%hh(inum2)%baclp * ts(ii)%hh(inum2)%flo *   
     &                               (1. - rnum1) + initlp * hrchwtr(ii)
          ...
          !! new concentration
          netwtr = 0.
          netwtr = ts(ii)%hh(inum2)%flo * (1. - rnum1) + hrchwtr(ii)
          if (netwtr >= 1.) then
      ...
      totbactp = ob(icmd)%hin%bacp * ob(icmd)%hin%flo * (1. - rnum1)    
     &                                     + ch(jrch)%bactp * rchwtr
      totbactlp = ob(icmd)%hin%baclp * ob(icmd)%hin%flo *               
     &                       (1. - rnum1) + ch(jrch)%bactlp * rchwtr
      ...
      !! new concentration
      netwtr = 0.
      netwtr = ob(icmd)%hin%flo * (1. - rnum1) + rchwtr
