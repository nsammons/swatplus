      ...
      if (i_exist == 0 .or. in_cha%init == 'null') then
        write (4444,4445) in_cha%init, mch_i, imax, '         null'
      ...
      read (105,*) header
       ...
       write (4444,4446) in_cha%init, mch_i, imax
      ...
      if (i_exist == 0 .or. in_cha%dat == 'null') then
       write (4444,4445) in_cha%dat, mch_i, imax, '         null'
        allocate (ch_dat(0:0))
      else   
      do
      ...
      write (4444,4446) in_cha%dat, mch_i, imax
      ...
      if (i_exist == 0 .or. in_cha%hyd == 'null') then
        write (4444,4445) in_cha%hyd, mch_i, imax, '         null'
        allocate (ch_hyd(0:0))
      else   
      do
      ...
      write (4444,4446) in_cha%hyd, mch_i, imax
