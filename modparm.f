...
!        real :: usle_mult
     ...
     &--   SOIL PROFILE   ----------'
      ...
      type field
           ...
           real :: len = 0.2  !!               |km            |field length for wind erosion
 ...
 !     end type hru_databases
      ...
      type (hydrologic_response_unit_db), dimension(:),allocatable :: 
     &                                                            hru_db
      ...
      type hydrologic_response_unit
        ...
        type (hydrology) :: hyd
        type (landuse) :: luse
        type (irrigation_sources) :: irrsrc
      end type hydrologic_response_unit
      type (hydrologic_response_unit), dimension(:), allocatable, target
     &                                                            :: hru
...
!    Drainmod tile equations  01/2006
      ...
      real, dimension (:,:), allocatable :: rainsub
