...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      sedyld(j)=sedyld(j) + latq(j) * hru(j)%km * 
     &               hru(j)%hyd%lat_sed
      sanyld(j)=sanyld(j)+latq(j) * hru(j)%km * 
     &               hru(j)%hyd%lat_sed * hru(j)%sol%det_san
      silyld(j)=silyld(j)+latq(j) * hru(j)%km * 
     &               hru(j)%hyd%lat_sed * hru(j)%sol%det_sil
      clayld(j)=clayld(j)+latq(j) * hru(j)%km * 
     &               hru(j)%hyd%lat_sed * hru(j)%sol%det_cla
      sagyld(j)=sagyld(j)+latq(j) * hru(j)%km * 
     &               hru(j)%hyd%lat_sed * hru(j)%sol%det_sag
      lagyld(j)=lagyld(j)+latq(j) * hru(j)%km * 
     &               hru(j)%hyd%lat_sed * hru(j)%sol%det_lag
