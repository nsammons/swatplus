      ...
      frac_in = 1. - bypass - ressa / hru(ihru)%ha
	...
	resgrai = grayld(ihru) * frac_in
     ...
     &                                        sedminpa(ihru)) * frac_in
      ...
      qdr(ihru) = resflwo / (10. * hru(ihru)%ha) + qday * bypass
        
      sedyld(ihru) = ressedo / hru(ihru)%ha + sedyld(ihru) * bypass
      sanyld(ihru) = ressano / hru(ihru)%ha + sanyld(ihru) * bypass
      silyld(ihru) = ressilo / hru(ihru)%ha + silyld(ihru) * bypass
	clayld(ihru) = resclao / hru(ihru)%ha + clayld(ihru) * bypass 
	sagyld(ihru) = ressago / hru(ihru)%ha + sagyld(ihru) * bypass
	lagyld(ihru) = reslago / hru(ihru)%ha + lagyld(ihru) * bypass
	grayld(ihru) = resgrao / hru(ihru)%ha + grayld(ihru) * bypass
      solpesti = 0.   !add soluble pest
      sorpesti = 0.   !add sorbed pest

      !! add incoming nutrients to those in reservoir
      !! equation 29.1.1 in SWAT manual
      sedorgn(ihru) = resorgno / hru(ihru)%ha + sedorgn(ihru) * bypass
      sedorgp(ihru) = resorgpo / hru(ihru)%ha + sedorgp(ihru) * bypass
      surqno3(ihru) = resno3o/ hru(ihru)%ha  + surqno3(ihru) * bypass
      !nh3 = resnh3o + 0.  !add ammonium 
      !no2  = resno2o + 0.  !add no2
      sedminps(ihru) = ressolpo / hru(ihru)%ha / 2. + sedminps(ihru) * 
     &                                                            bypass
      sedminpa(ihru) = ressolpo / hru(ihru)%ha / 2. + sedminpa(ihru) *
     &                                                            bypass
