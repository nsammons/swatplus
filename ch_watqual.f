...
!! concentrations
         ...
         cinn = 0.
         if (wtrin > 0.001) then
         chlin = 1000. * ob(icmd)%hin%chla * (1. - rnum1) / wtrin
         algin = 1000. * chlin / ch_nut(jnut)%ai0        !! QUAL2E equation III-1
         orgnin = 1000. * ob(icmd)%hin%orgn * (1. - rnum1) / wtrin
         ammoin = 1000. * ob(icmd)%hin%nh3 * (1. - rnum1) / wtrin
         nitritin = 1000. * ob(icmd)%hin%no2 * (1. - rnum1) / wtrin
         nitratin = 1000. * ob(icmd)%hin%no3 * (1. - rnum1) / wtrin
         orgpin = 1000. * ob(icmd)%hin%sedp * (1. - rnum1) / wtrin
         dispin = 1000. * ob(icmd)%hin%solp * (1. - rnum1) / wtrin
         cbodin = 1000. * ob(icmd)%hin%cbod * (1. - rnum1) / wtrin
         disoxin = 1000. * ob(icmd)%hin%dox * (1. - rnum1) / wtrin
         end if
...
!! oxygen calculations
	   ...
	   if (ch(jrch)%rch_cbod > dcoef * cbodcon) ch(jrch)%rch_cbod = dcoef *
     &	   cbodcon
